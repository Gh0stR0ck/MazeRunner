...
namespace IO.Swagger.Api
{
    ...
    public interface IMazeApi : IApiAccessor
    {
        ...
        /// <param name="tagValue"></param>
        /// <returns>ApiResponse of PossibleActionsAndCurrentScore</returns>
        ApiResponse<PossibleActionsAndCurrentScore> TagWithHttpInfo (long? tagValue);
        ...
        /// <param name="tagValue"></param>
        /// <returns>Task of PossibleActionsAndCurrentScore</returns>
        System.Threading.Tasks.Task<PossibleActionsAndCurrentScore> TagAsync (long? tagValue);
        ...
        /// <param name="tagValue"></param>
        /// <returns>Task of ApiResponse (PossibleActionsAndCurrentScore)</returns>
        System.Threading.Tasks.Task<ApiResponse<PossibleActionsAndCurrentScore>> TagAsyncWithHttpInfo (long? tagValue);
    ...
    public partial class MazeApi : IMazeApi
    {
        ...
        /// <summary>
        /// Tag the current tile with the given (non-negative) number You must have already entered a maze. This method will return 200 even if you already tagged this tile. By tagging a tile \&quot;again\&quot; you will rewrite the previous tag.‍
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="tagValue"></param>
        /// <returns>PossibleActionsAndCurrentScore</returns>
        public PossibleActionsAndCurrentScore Tag (long? tagValue)
        {
             ApiResponse<PossibleActionsAndCurrentScore> localVarResponse = TagWithHttpInfo(tagValue);
             return localVarResponse.Data;
        }
        ...
        /// <param name="tagValue"></param>
        /// <returns>ApiResponse of PossibleActionsAndCurrentScore</returns>
        public ApiResponse< PossibleActionsAndCurrentScore > TagWithHttpInfo (long? tagValue)
        {
            // verify the required parameter 'tagValue' is set
            if (tagValue == null)
                throw new ApiException(400, "Missing required parameter 'tagValue' when calling MazeApi->Tag");

            var localVarPath = "/api/maze/tag";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("Tag", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="tagValue"></param>
        /// <returns>Task of PossibleActionsAndCurrentScore</returns>
        public async System.Threading.Tasks.Task<PossibleActionsAndCurrentScore> TagAsync (long? tagValue)
        {
             ApiResponse<PossibleActionsAndCurrentScore> localVarResponse = await TagAsyncWithHttpInfo(tagValue);
             return localVarResponse.Data;
        ...
        /// <param name="tagValue"></param>
        /// <returns>Task of ApiResponse (PossibleActionsAndCurrentScore)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PossibleActionsAndCurrentScore>> TagAsyncWithHttpInfo (long? tagValue)
        {
            // verify the required parameter 'tagValue' is set
            if (tagValue == null)
                throw new ApiException(400, "Missing required parameter 'tagValue' when calling MazeApi->Tag");
